...
out_file_name <- "Plots/BootstrapFailure/BootstrapFailure1"
...
out_file_name <- "Plots/BootstrapFailure/BootstrapFailure2"
...
out_file_name <- "Plots/BootstrapFailure/BootstrapFailure3"
...
# Make actual plot
out_file_name <- "Plots/BootstrapFailure/BootstrapFailure4"
